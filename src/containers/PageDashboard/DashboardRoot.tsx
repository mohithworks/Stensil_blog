...
const DashboardRoot = () => {
  ...
  const updateProfile = (e:any) => {
      e.preventDefault();
      if(name == "" || title == "" || description == "" || !logoImg || !faviconImg) {
  ...
  if(loading) {
    ...
    const {username} = authorDetails[0];
    return (
      ...
      <div className="rounded-xl min-h-full text-sm border border-neutral-100 dark:border-neutral-800 p-6 md:text-base">
        ...
        </span> */}
        {
          (username != null) ? (
            ...
            <p>From your account dashboard you can view your dashboard, manage your</p>
          ...
          <form className="grid md:grid-cols-2 gap-6" action="#" method="post">
            <label className="block">
              ...
              <Input onChange={(e) => setTitle(e.target.value)} placeholder="Title" type="text" className="mt-1" />
            </label>
            <label className="block">
              <Label>Blog Name</Label>
              <Input onChange={handleName} placeholder="blogname.stensil.com" type="text" className="mt-1" />
            </label>
            <label className="block md:col-span-2">
              <Label>Blog Description</Label>

              <Textarea onChange={(e) => setDescription(e.target.value)} className="mt-1" rows={4} />
